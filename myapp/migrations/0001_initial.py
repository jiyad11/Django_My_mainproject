    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount_and_bill', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.payments')),
            ],
        ),
        migrations.CreateModel(
            name='appointment',
            fields=[
                ...
                ('Customuser', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('Schedule', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.schedule')),
            ],
        ),
    ]
